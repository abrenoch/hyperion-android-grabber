...
public class HyperionAudioThread extends Thread {
    private String HOST;
    private int PORT;
    ...
    HyperionAudioService.HyperionAudioThreadBroadcaster mSender;
    ...
    public HyperionAudioThread(HyperionAudioService.HyperionAudioThreadBroadcaster listener, final String host,
